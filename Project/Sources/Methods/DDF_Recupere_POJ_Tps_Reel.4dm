//%attributes = {}
// cette méthode récupère les plannings de garde de Nexsis à partir de la veille
// il y a d'abord un effacement des données de ces POJ puis alimentation avec les nouvelles données
...
$TSVeille:=4DStmp_Write($date; ?00:00:00?)
$jour:=String:C10(Day of:C23($date); "00")
$mois:=String:C10(Month of:C24($date); "00")
$annee:=String:C10(Year of:C25($date); "0000")
$chaineJour:=$annee+"-"+$mois+"-"+$jour  //+"T00:00:00+00:00"


$requete:="?source=eq.prod&date_debut=gte."+$chaineJour+"&code_position_administrative=isdistinct.null"
...
If ($httpResponse=200)
	...
	QUERY:C277([fdg_donnees_poj:184]; [fdg_donnees_poj:184]TS_Debut:14>=$TSVeille)
