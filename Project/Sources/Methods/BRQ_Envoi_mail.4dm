...
$hier:=String:C10(Add to date:C393(Current date:C33; 0; 0; -1); Interne date court:K1:7)
...
$email.subject:="BRQ du "+$today
$email.textBody:="Bonjour"+Char:C90(Retour à la ligne:K15:40)+"Veuillez trouver ci-joint les données pour le BRQ des opérations entre le "+$hier+" à 6h30 et le "+$today+" à 6h30."+Char:C90(Retour à la ligne:K15:40)
$email.textBody:=$email.textBody+"Vous trouverez également en 2eme partie de mail le détail des interventions de la nuit pout l'OSD."+Char:C90(Retour à la ligne:K15:40)
$email.textBody:=$email.textBody+"Ce document est rédigé automatiquement à partir des données de NexSIS. Il vous sera envoyé tous les matins."+Char:C90(Retour à la ligne:K15:40)
