...
$dateApres:=Add to date:C393($date; 0; 0; 1)
...
$chaineJourApres:=$anneeApres+"-"+$moisApres+"-"+$jourApres  //+"T00:00:00+00:00"

$requete:="?source=eq.prod&date_debut=gte."+$chaineJour+"&date_debut=lte."+$chaineJourApres+"&code_position_administrative=isdistinct.null"
