//%attributes = {}
// cette méthode récupère les détails des affaires qualifiées
// elle les stocke dans la table "sga_traitement"
$annee:=$1
$mois:=$2
$tableNexSIS:="sga_traitement"
...
C_TEXT:C284($url)
$url:="https://vm-donnees-froides.ansc.nexsis18-112.fr:443/api/2a/"+$tableNexSIS+"?date_creation=gte."+$dateDebut+"&nature_de_fait_0_code=not.is.null&code_sis=eq.02a-cga&source=eq.prod"
