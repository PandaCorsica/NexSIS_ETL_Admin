//%attributes = {}
// cette méthode récupère les détails des opérations dont les CRSS ont été chargés mais pas encore traités
// elle les stocke dans la table "crss_operation"
$annee:=$1
$mois:=$2
...
While (Not:C34(End selection:C36([crss_validation:154])))
	...
	C_TEXT:C284($url)
	$url:="https://vm-donnees-froides.ansc.nexsis18-112.fr:443/api/2a/"+$tableNexSIS+"?id_operation=eq."+[crss_validation:154]id_operation:2+"&code_sis=eq.02a-sis"
