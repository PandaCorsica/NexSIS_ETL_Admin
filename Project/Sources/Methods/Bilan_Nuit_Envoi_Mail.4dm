...
$email.subject:="Bilan de la nuit du "+$hier+" au "+$today
$email.textBody:="Bonjour"+Char:C90(Retour à la ligne:K15:40)+"Veuillez trouver ci-joint le récapitulatif des opérations du "+$hier+" au "+$today+" entre 19h00 et 06h30 afin de faire un point à l'OSD."+Char:C90(Retour à la ligne:K15:40)
