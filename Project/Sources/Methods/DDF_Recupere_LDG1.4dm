//%attributes = {}
// cette méthode récupère les plannings des nuits des derniers jours de janvier et de février
// elle les stocke dans la table "fdg_service_fait"
$annee:=2024
$mois:=2
$tableNexSIS:="fdg_service_fait"
$dateDebut:=String:C10($annee)+"-"+String:C10($mois; "00")+"-29T18%3A00%3A00%2B00%3A00"  // formet Annee-mois-jourTheure:minutes:secondes+heuredecallage:minutesDecallage
