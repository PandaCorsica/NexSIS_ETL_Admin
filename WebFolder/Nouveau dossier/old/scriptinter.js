...
function chargerCommunes() {
    //const url = 'http://127.0.0.1:5500/fiche_inter/listecommunes.json'; 
...
function rechercherDonnees() {
    ...
    //const url = 'http://127.0.0.1:5500/fiche_inter/listeinter.json'; 
    const url = urlServeur + '/listeinter?dateDeb=' + document.getElementById('date-debut').value + "&heureDeb=" + document.getElementById('heure-debut').value + "&dateFin=" + document.getElementById('date-fin').value + "&heureFin=" + document.getElementById('heure-fin').value + "&commune=" + document.getElementById('commune-select').value + "&numinter=" + document.getElementById('numero-intervention').value;
    let tableau = [];
